    ...
    if (tab === 'general') {
      return (
        <div className="grid gap-3 md:grid-cols-2">
          ...
          <FormField label="Short description" htmlFor="product-short-description" className="md:col-span-2">
            <textarea
              ...
              onChange={(e) => setProductFormField(setForm, 'shortDescription', e.target.value)}
            />
          </FormField>
